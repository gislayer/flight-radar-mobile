...
import { Image, StyleSheet, TextInput, Pressable, Platform } from 'react-native';
...
export default function HomeScreen() {
  ...
  const [routeId, setRouteId] = useState<number>(78330);
  ...
  var APIURl = Platform.select({ios:'http://localhost:2003/api', android:'http://192.168.1.23:2003/api'});
  const api = new API({newurl:APIURl});
